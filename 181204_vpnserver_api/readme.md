...
- You can omit the above HTTPS custom authenticaion headers if you are calling JSON-RPC APIs from the web browser which is already logged in to the VPN Server with HTTPS Basic Authtication. In such usage the credential of HTTPS Basic Authtication will be used.
...
```json
{
  ...
  "result": {
    ...
    "ServerType_u32": 0,
    "ServerBuildDate_dt": "2019-08-01T12:24:36.123",
...
```json
{
  ...
  "result": {
    ...
    "CurrentTime_dt": "2019-08-01T12:24:36.123",
    "CurrentTick_u64": 0,
    "StartTime_dt": "2019-08-01T12:24:36.123",
    "TotalMemory_u64": 0,
    "UsedMemory_u64": 0,
    "FreeMemory_u64": 0,
    "TotalPhys_u64": 0,
...
```json
{
  ...
  "result": {
    ...
    "ConnectedTime_dt": "2019-08-01T12:24:36.123",
    "Ip_ip": "192.168.0.1",
...
```json
{
  ...
  "result": {
    ...
    "Online_bool": false,
    "LastError_u32": 0,
    "StartedTime_dt": "2019-08-01T12:24:36.123",
    "FirstConnectedTime_dt": "2019-08-01T12:24:36.123",
    "CurrentConnectedTime_dt": "2019-08-01T12:24:36.123",
    "NumTry_u32": 0,
    "NumConnected_u32": 0,
    "NumFailed_u32": 0
  }
    ...
    "HubList": [
      {
        ...
        "NumMacTables_u32": 0,
        "NumIpTables_u32": 0,
        "LastCommTime_dt": "2019-08-01T12:24:36.123",
        "LastLoginTime_dt": "2019-08-01T12:24:36.123",
        "CreatedTime_dt": "2019-08-01T12:24:36.123",
        "NumLogin_u32": 0,
    ...
    "CAList": [
      {
        ...
        "Expires_dt": "2019-08-01T12:24:36.123"
      },
      {
        "Key_u32": 0,
        "SubjectName_utf": "subjectname",
...
```json
{
  ...
  "result": {
    ...
    "ClientX_bin": "SGVsbG8gV29ybGQ=",
    "StartTime_dt": "2019-08-01T12:24:36.123",
    "FirstConnectionEstablisiedTime_dt": "2019-08-01T12:24:36.123",
    "CurrentConnectionEstablishTime_dt": "2019-08-01T12:24:36.123",
    ...
    "AccessListSingle": [
      {
        ...
        "SrcSubnetMask_ip": "192.168.0.1",
        "DestIpAddress_ip": "192.168.0.1",
        "DestSubnetMask_ip": "192.168.0.1",
...
```json
{
  ...
  "params": {
    ...
    "Note_utf": "note",
    "ExpireTime_dt": "2019-08-01T12:24:36.123",
    "AuthType_u32": 0,
...
```json
{
  ...
  "result": {
    ...
    "Note_utf": "note",
    "CreatedTime_dt": "2019-08-01T12:24:36.123",
    "UpdatedTime_dt": "2019-08-01T12:24:36.123",
    "ExpireTime_dt": "2019-08-01T12:24:36.123",
    "AuthType_u32": 0,
    "Auth_Password_str": "auth_password",
    "UserX_bin": "SGVsbG8gV29ybGQ=",
...
`CommonName_utf` | `string` (UTF8) | Certificate Common Name, optional,v alid only if AuthType_u32 == RootCert(3).
`RadiusUsername_utf` | `string` (UTF8) | Username in RADIUS server, optional, valid only if AuthType_u32 == Radius(4).
`NtUsername_utf` | `string` (UTF8) | Username in NT Domain server, optional, valid only if AuthType_u32 == Radius(4).
...
```json
{
  ...
  "result": {
    ...
    "DhcpTable": [
      {
        "Id_u32": 0,
        "LeasedTime_dt": "2019-08-01T12:24:36.123",
        "ExpireTime_dt": "2019-08-01T12:24:36.123",
        "MacAddress_bin": "SGVsbG8gV29ybGQ=",
        "IpAddress_ip": "192.168.0.1",
        "Mask_u32": 0,
...
***
## "GetVgsConfig" RPC API - Get the VPN Gate Server Configuration (Sync mode).
